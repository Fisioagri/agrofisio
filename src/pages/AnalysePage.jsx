      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="font-mono text-xs text-ink-400 mt-0.5">
            {lang === 'en' ? 'protocol · 8 steps' : 'protocolo · 8 etapas'}
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            {total > 0 && (
              <div className="font-mono text-[10px] text-ink-300">{laudos.length}/{total}</div>
            )}
          </div>
          ...
          {loading ? (
            ...
            <div className="bg-white border border-surface-border rounded-card p-6 text-center shadow-card">
              ...
              <Link
                to="/wizard"
                className="mt-3 inline-block font-mono text-xs text-brand-700 underline"
              >
